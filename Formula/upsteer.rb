class Upsteer < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/upsteer-ai/upsteer/releases/download/v0.1.0/upsteer_darwin_arm64.tar.gz"
      sha256 "4a2fd9ffdd581f4d1db04c79119dca010d755a9f874a9d45b91faea464dc7df7"
    else
      url "https://github.com/upsteer-ai/upsteer/releases/download/v0.1.0/upsteer_darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/upsteer-ai/upsteer/releases/download/v0.1.0/upsteer_linux_arm64.tar.gz"
      sha256 "f556153d17e5b140ba11ad7a855f94094685773b1bac11d507255df1691e1568"
    else
      url "https://github.com/upsteer-ai/upsteer/releases/download/v0.1.0/upsteer_linux_amd64.tar.gz"
